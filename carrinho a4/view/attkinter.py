...
def atualizar_carrinho(cliente):
    texto_carrinho = exibir_carrinho(cliente, carrinhos.get(cliente["nome"], ["quantidade"]))
...
# receber os dados , preciso estudaar banco de dados ou json para tornar funcional
#? se nao prrencho aqui o codigo nao funciona entao predefini um cliente, e um produto
clientes = [{"nome": "Xavier"}]
produtos = [{"nome": "Computador", "quantidade": 10}]
carrinhos = {cliente["nome"]: [] for cliente in clientes}

#!aqui eu gosto de deixa pra configurar o tamanho da main box
root = tk.Tk()
